//
//  tdbyesterdayViewController.swift
//  Watercharger
//
...
//let ViewControllerIDs = ["homeViewController", "yesterdayViewController", "twobeforeViewController"]

class tdbyesterdayViewController: UIViewController,UITableViewDelegate,UITableViewDataSource{
    ...
    let tdbyesterday = Calendar(identifier: .gregorian).date(byAdding: .day, value: -2, to: Date())
    ...
    func tableView(_ tableView: UITableView,
        ...
        return stringFromDate(date: tdbyesterday!, format: "M月dd日")
    }
    func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        let label = UILabel()
        label.font = UIFont(name: "Helvetica-Bold", size: 24)
        label.text = stringFromDate(date: tdbyesterday!, format: "M月dd日")
        return label
    }
    ...
    func serch(){
        let day = stringFromDate(date: tdbyesterday!, format: "M月dd日")
    ...
    func tableView(_ tableView: UITableView, commit editingStyle: UITableViewCell.EditingStyle, forRowAt indexPath: IndexPath){
        ...
        let action = UIAlertAction(title: "OK", style: .default) { (_) in
            let selectedId = self.customCell[indexPath.row].id
